# Contributing to Flowline Pro

First off, thank you for considering contributing to Flowline Pro! It's people like you that make Flowline Pro a great tool for the community.

This document provides guidelines and instructions for contributing to the Flowline Pro project.
...
1. **Fork the repository**
   ...
   Click the "Fork" button on the [GitHub repository](https://github.com/pdovhomilja/flowlinepro-app) to create your own copy.

2. **Clone your fork**

   ```bash
   git clone https://github.com/YOUR_USERNAME/flowlinepro-app.git
   cd flowlinepro-app
   ```
...
If you find a bug, please [open an issue](https://github.com/pdovhomilja/flowlinepro-app/issues) with the following information:
...
Flowline Pro supports multiple languages (English, Czech, German, Ukrainian):
...
Based on our [roadmap](https://github.com/pdovhomilja/flowlinepro-app#roadmap), here are priority areas:
...
- **Twitter**: [@flowlineproapp](https://twitter.com/flowlineproapp)

## Recognition

Contributors will be recognized in our README and release notes. Thank you for helping make Flowline Pro better!

---

By contributing to Flowline Pro, you agree that your contributions will be licensed under the [MIT License](LICENSE.md).
