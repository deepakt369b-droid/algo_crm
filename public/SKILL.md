---
name: pipelinepro
description: Connect to PipelinePro MCP server to manage CRM data — accounts, contacts, leads, opportunities, targets, products, contracts, activities, documents, target lists, enrichment, email accounts, campaigns, projects, and reports.
---

# PipelinePro MCP Server Skill

Use the PipelinePro MCP server to read and write CRM data. This skill documents all available tools and how to use them.
...
- Replace `YOUR_NEXTCRM_URL` with your PipelinePro instance URL (e.g. `http://localhost:3000` for local dev)
