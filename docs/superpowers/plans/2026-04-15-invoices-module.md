...
**Goal:** Build a full Invoices module in flowlinepro-app: create, issue, store PDFs in MinIO, link to CRM Accounts/Products, multi-currency, configurable VAT, search, payments, send-by-email.
...
const BUCKET = process.env.MINIO_BUCKET ?? "flowlinepro";
