...
```bash
rm /Users/pdovhomilja/development/Next.js/flowlinepro-app/actions/fulltext/search.ts
rm /Users/pdovhomilja/development/Next.js/flowlinepro-app/actions/fulltext/get-search-results.ts
```
