...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && pnpm tsc --noEmit
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && grep -n "websiteInvalid" messages/*.json
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && git add app/[locale]/\(routes\)/crm/accounts/components/NewAccountForm.tsx messages/ && git commit -m "refactor(crm): relax NewAccountForm validation to require only name"
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && grep -n "formSchema\|z.object\|z.string" "app/[locale]/(routes)/crm/accounts/components/UpdateAccountForm.tsx" | head -40
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && git add "app/[locale]/(routes)/crm/accounts/components/UpdateAccountForm.tsx" && git commit -m "refactor(crm): relax UpdateAccountForm validation to require only name"
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && grep -n "crm/account.saved" actions/crm/accounts/
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && pnpm lint && pnpm tsc --noEmit
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && git log --oneline dev..HEAD && git diff dev..HEAD --stat
```
...
```bash
cd /Users/pdovhomilja/development/Next.js/flowlinepro-app && git push -u origin HEAD
```
