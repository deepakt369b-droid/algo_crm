...
const Header = ({ id, lang }: Props) => {
  return (
    <>
      <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between gap-2 px-6 backdrop-blur-md bg-background/80 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 border-b border-border/40">
