...
```bash
DATABASE_URL_MONGODB="mongodb://user:pass@localhost:27017/flowlinepro"
DATABASE_URL_POSTGRES="postgresql://user:pass@localhost:5432/flowlinepro"
```

**Option 2: Single URL** (if already switched to PostgreSQL)
```bash
DATABASE_URL="postgresql://user:pass@localhost:5432/flowlinepro"
...
```
================================================================
         Flowline Pro Migration Validation Report
================================================================
