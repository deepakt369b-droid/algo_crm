...
This directory contains the migration tooling for migrating Flowline Pro from MongoDB to PostgreSQL. The migration supports:
...
```bash
# .env
DATABASE_URL="postgresql://username:password@localhost:5432/flowlinepro"
```
