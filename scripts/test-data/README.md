...
# Connection string
DATABASE_URL_MONGODB="mongodb://admin:password@localhost:27017/flowlinepro_test?authSource=admin"
```
...
docker run -d --name postgres-migration-test \
  -p 5432:5432 \
  -e POSTGRES_USER=flowlinepro \
  -e POSTGRES_PASSWORD=password \
  -e POSTGRES_DB=flowlinepro_test \
  pgvector/pgvector:pg16

# Connection string
DATABASE_URL_POSTGRES="postgresql://flowlinepro:password@localhost:5432/flowlinepro_test"
```

### 3. Run Prisma Migrations
```bash
# Point to PostgreSQL test database
export DATABASE_URL="postgresql://flowlinepro:password@localhost:5432/flowlinepro_test"
