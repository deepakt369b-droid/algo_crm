...
This file is the authoritative guide for AI agents (Claude Code and other LLM agents) working in the `flowlinepro-app` project. It covers context management, available superpowers/skills, current repo status, and available MCP servers.
